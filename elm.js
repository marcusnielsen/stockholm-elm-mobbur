...
Elm.DoubleChevron = Elm.DoubleChevron || {};
Elm.DoubleChevron.make = function (_elm) {
   "use strict";
   _elm.DoubleChevron = _elm.DoubleChevron || {};
   if (_elm.DoubleChevron.values) return _elm.DoubleChevron.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var foo = function (_p0) {    return $Html.text($Basics.toString(_p0));};
   var main = A2($Signal.map,foo,$Time.every($Time.second));
   return _elm.DoubleChevron.values = {_op: _op,main: main,foo: foo};
};
